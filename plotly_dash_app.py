...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider',
                                    ...
                                    max=10000,
                                    step=2500,
                                    marks={v:str(v) for v in range(0, 12500, 2500)},
...
def get_pie_chart(selected_site):
    if selected_site == 'ALL':
        ...
        filtered_df = spacex_df.loc[spacex_df['Launch Site'] == selected_site]
        fig = px.pie(filtered_df, names='class', title=f'Success Rate for site {selected_site}')
    return fig
...
def get_scatter_chart(selected_site, selected_payload):
    ...
    if selected_site == 'ALL':
        ...
        filtered = data.loc[data['Launch Site'] == selected_site]
